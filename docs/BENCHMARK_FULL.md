...
| 页面渲染（151 文件公共集，DPI 150） | **flashpdf 19.76ms** | liteparse 1.4×、pypdfium2 3.0×、PyMuPDF 4.3×、pdf_oxide 5.7× | 同 PDFium 内核但 PNG 编码更快 |
...
|---|---:|---:|---|
| **flashpdf** | **1** (3.06ms) | **1** (19.76ms) | — (双第一) |
| liteparse | 10 (1609ms, **最慢**) | **2** (27.87ms) | **+8 位**（文本最差，渲染第二）|
| pdf_oxide | 2 (34ms) | 5 (112ms) | **-3 位**（文本第二，渲染第五）|
...
### 2.2 151 文件公共集（apples-to-apples）

| 库 | mean | p50 | p90 | 总耗时 | vs flashpdf |
|---|---:|---:|---:|---:|---:|
| **flashpdf** | **19.76ms** | **15.96ms** | **33.23ms** | **2.98s** | **1.0×** |
| liteparse | 27.87ms | 23.68ms | 42.81ms | 4.21s | 1.41× |
| pypdfium2 | 59.60ms | 57.65ms | 71.55ms | 9.00s | 3.02× |
| PyMuPDF | 84.66ms | 73.14ms | 120.06ms | 12.78s | 4.28× |
| pdf_oxide | 112.48ms | 49.21ms | 139.79ms | 16.98s | 5.69× |

### 2.3 按文件大小分桶（公共 151 文件 p50 ms）

| 桶 | n | flashpdf | liteparse | pdf_oxide | pypdfium2 | PyMuPDF |
|---|---:|---:|---:|---:|---:|---:|
| tiny <10KB | 29 | **14.31** | 18.35 | 32.26 | 55.02 | 59.75 |
| small 10-100KB | 47 | **11.43** | 19.34 | 44.29 | 53.03 | 67.66 |
| medium 100KB-1MB | 57 | **21.37** | 29.29 | 62.90 | 60.68 | 80.74 |
| large >1MB | 18 | **24.65** | 32.10 | 67.18 | 63.80 | 92.83 |
...
| **渲染稳定性第一（零失败）** | liteparse / pypdfium2 / PyMuPDF（165/165）| flashpdf 修了 bug 后也能进 |
